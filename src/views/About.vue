...
const codeLines = createLines([
    ...
    { content: '  <div class="about-content" :class="{ visible: isVisible }">', class: "punctuation" },
    { content: '    <div class="about-header">', class: "punctuation" },
    { content: "      <h1>About Me</h1>", class: "" },
    { content: '      <p class="bio">', class: "" },
    { content: "        I'm a passionate Full Stack Developer with over 3", class: "string" },
    { content: "        years of experience building modern web applications.", class: "string" },
    { content: "      </p>", class: "" },
    { content: '      <div class="resume-download">', class: "punctuation" },
    { content: '        <a href="/resume.pdf" download="Jordi_Osarenkhoe_Resume.pdf"', class: "" },
    { content: '          class="download-btn" @click="handleResumeDownload">', class: "" },
    { content: "          Download Resume", class: "string" },
    { content: "        </a>", class: "punctuation" },
    { content: "      </div>", class: "punctuation" },
    { content: "    </div>", class: "punctuation" },
    "",
    { content: '    <div class="github-stats-section">', class: "punctuation" },
    { content: "      <h2>GitHub Statistics</h2>", class: "" },
    { content: '      <div class="github-stats-grid">', class: "punctuation" },
    { content: '        <GitHubStatsCard label="Repositories"', class: "" },
    { content: '          :value="userStats?.totalRepos || 0" icon="📦"', class: "string" },
    { content: '          :isLoading="isLoadingGithub" />', class: "" },
    { content: '        <GitHubStatsCard label="Total Stars"', class: "" },
    { content: '          :value="userStats?.totalStars || 0" icon="⭐"', class: "string" },
    { content: '          :isLoading="isLoadingGithub" />', class: "" },
    { content: "      </div>", class: "punctuation" },
    { content: "    </div>", class: "punctuation" },
    "",
    { content: '    <div class="skills-section">', class: "punctuation" },
    { content: "      <h2>Skills & Technologies</h2>", class: "" },
    { content: '      <div class="skills-grid">', class: "punctuation" },
    { content: '        <div v-for="skill in skills" :key="skill.name"', class: "" },
    { content: '          class="skill-item">', class: "" },
    { content: '          <component :is="skill.icon"', class: "" },
    { content: '            :fill="skill.color" :size="48" />', class: "" },
    { content: '          <span class="skill-name">{{ skill.name }}</span>', class: "" },
    { content: "        </div>", class: "punctuation" },
    { content: "      </div>", class: "punctuation" },
    { content: "    </div>", class: "punctuation" },
    "",
    { content: '    <div class="experience-section">', class: "punctuation" },
    { content: "      <h2>Experience</h2>", class: "" },
    { content: '      <div class="timeline">', class: "punctuation" },
    { content: '        <div v-for="(exp, index) in experience" :key="index"', class: "" },
    { content: '          class="timeline-item">', class: "" },
    { content: '          <div class="timeline-marker"></div>', class: "" },
    { content: '          <div class="timeline-content">', class: "punctuation" },
    { content: "            <h3>{{ exp.role }}</h3>", class: "" },
    { content: '            <span class="company">{{ exp.company }}</span>', class: "" },
    { content: '            <span class="duration">{{ exp.duration }}</span>', class: "" },
    { content: "            <p>{{ exp.description }}</p>", class: "" },
    { content: '            <div class="technologies">', class: "punctuation" },
    { content: '              <span v-for="tech in exp.technologies" :key="tech"', class: "" },
    { content: '                class="tech-badge">{{ tech }}</span>', class: "" },
    { content: "            </div>", class: "punctuation" },
    { content: "          </div>", class: "punctuation" },
    { content: "        </div>", class: "punctuation" },
    { content: "      </div>", class: "punctuation" },
    { content: "    </div>", class: "punctuation" },
    "",
    { content: '    <div class="education-section">', class: "punctuation" },
    { content: "      <h2>Education & Certifications</h2>", class: "" },
    { content: '      <div v-for="edu in education" :key="edu.degree"', class: "" },
    { content: '        class="education-item">', class: "" },
    { content: '        <div class="education-header">', class: "punctuation" },
    { content: "          <h3>{{ edu.degree }}</h3>", class: "" },
    { content: '          <span class="institution">{{ edu.institution }}</span>', class: "" },
    { content: '          <span class="duration">{{ edu.duration }}</span>', class: "" },
    { content: "        </div>", class: "punctuation" },
    { content: "        <p>{{ edu.description }}</p>", class: "" },
    { content: "      </div>", class: "punctuation" },
    { content: "    </div>", class: "punctuation" },
    "",
    { content: '    <div class="interests-section">', class: "punctuation" },
    { content: "      <h2>Interests & Hobbies</h2>", class: "" },
    { content: '      <div class="interests-grid">', class: "punctuation" },
    { content: '        <div class="interest-item"><span>Open Source</span></div>', class: "" },
    { content: '        <div class="interest-item"><span>Learning New Tech</span></div>', class: "" },
    { content: '        <div class="interest-item"><span>Community</span></div>', class: "" },
    { content: '        <div class="interest-item"><span>Problem Solving</span></div>', class: "" },
    { content: "      </div>", class: "punctuation" },
    { content: "    </div>", class: "punctuation" },
    { content: "  </div>", class: "punctuation" },
    { content: "</template>", class: "keyword" },
